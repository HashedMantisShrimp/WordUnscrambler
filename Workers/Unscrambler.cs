...
namespace WordUnScrambler.Workers
{
    class Unscrambler
    {
        ...
        public void MatchesFound(string[] scrambledWords) {
            ...
            {
                Console.WriteLine();
                Console.WriteLine(Constants.CaseMatchesFound);
                foreach (var element in Matches)
                {
                    Console.WriteLine(Constants.OutputMatches, element.SramcbledWord,element.Word);
                }
            }
            else
            {
                Console.WriteLine();
                Console.WriteLine(Constants.CaseNoMatchesFound);
            }
        }
    }
}
